...
const SOP_GROUPS = [
    ...
    {
        id: 3,
        nomorSop: '100.3.8/31/Setda/2024',
        namaSop: 'Keanggotaan Perpustakaan JDIH (Layanan Informasi)',
        tanggalPengesahan: '31 Desember 2024',
        disahkanOleh: 'Kepala Bagian Hukum',
        tujuan: 'Menjamin tersedianya informasi hukum sebagai Pusat Jaringan Dokumentasi dan Informasi Hukum Kabupaten Banjarnegara.',
        pages: [
            { src: '/images/SOP_JDIH_004.png', label: 'Prosedur Layanan Informasi Hukum JDIH' },
        ],
    },
];

/* Flat list of all pages for lightbox navigation */
const ALL_PAGES = SOP_GROUPS.flatMap((group) =>
...
export default function Sop() {
    ...
    const groupOffsets = SOP_GROUPS.reduce<number[]>((acc, g, i) => {
        acc.push(i === 0 ? 0 : acc[i - 1] + SOP_GROUPS[i - 1].pages.length);
        return acc;
    }, []);
        ...
        <PublicLayout>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-slate-500 text-sm max-w-xl mx-auto">
                            Terdapat <strong>{SOP_GROUPS.length} SOP</strong> dengan total{' '}
                            <strong>{ALL_PAGES.length} halaman</strong> dokumen.
            ...
            {lightboxIdx !== null && (
                <Lightbox
                    ...
                    onNext={() =>
                        setLightboxIdx((i) =>
                            i !== null && i < ALL_PAGES.length - 1 ? i + 1 : i
                        )
                    }
                />
            )}
