const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/IKMSurveyModal-CdT3Clli.js","assets/app-Bh4WKNc7.js","assets/vendor-inertia-BrKII0hO.js","assets/vendor-axios-BYo4GULv.js","assets/app-PZqCmMYV.css","assets/vendor-lucide-Bh7ZYQ0n.js"])))=>i.map(i=>d[i]);
import{j as e,_ as H}from"./app-Bh4WKNc7.js";import{r as d,L as m}from"./vendor-inertia-BrKII0hO.js";import{a9 as P,aa as K,ab as z,ac as M,ad as C,ae as I,af as L,ag as T,E as $,ah as R,ai as O,X as j,aj as _,ak as J,al as F,am as G,Y as U,a as W,an as V,O as X,J as Y,x as q,g as Q}from"./vendor-lucide-Bh7ZYQ0n.js";const E="jdih_a11y_settings",w={ttsEnabled:!1,fontSize:0,highContrast:!1,darkMode:!1,textSpacing:!1,underlineLinks:!1,hideImages:!1,readingGuide:!1};function Z(){try{const a=localStorage.getItem(E);if(a)return{...w,...JSON.parse(a)}}catch{}return{...w}}function D(a){try{localStorage.setItem(E,JSON.stringify(a))}catch{}}function ee(a){let n=document.getElementById("a11y-global-styles");n||(n=document.createElement("style"),n.id="a11y-global-styles",document.head.appendChild(n));const s=a.fontSize===0?"100%":a.fontSize===1?"110%":a.fontSize===2?"125%":a.fontSize===-1?"90%":"80%",o=a.textSpacing?"2.2":"1.6",i=a.textSpacing?"0.08em":"normal",l=a.textSpacing?"0.18em":"normal";let r=`
        /* Font size */
